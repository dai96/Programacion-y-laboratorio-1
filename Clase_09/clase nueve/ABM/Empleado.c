...
int buscarLegajo (eEmpleado lista [], int t)
{
    int aux, retorno=-1, i;
...
int modificarlegajo (eEmpleado lista[], int indice)
{
    float aux;
    printf("reeingrese sueldo bruto: ");
    scanf("%f",&aux);

    lista[indice].sueldoBruto = aux;
    lista[indice].sueldoNeto = aux * 0.85;
